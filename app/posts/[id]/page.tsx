        ...
        <section className="mt-8 border-t border-gray-100 pt-8">
          ...
          <form onSubmit={handleCommentSubmit} className="mb-10">
            ...
            <div className="flex justify-end mt-2">
              <button
                ...
                className="px-4 py-2 text-sm font-medium bg-gray-900 text-white rounded-full hover:bg-gray-700 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
              >
          ...
          {comments.length > 0 && (
            <ul className="space-y-6">
              {comments.map((c) => (
                <li key={c.id} className={`flex gap-3 ${c.parent !== 0 ? "ml-10" : ""}`}>
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                      ...
                      <div className="mt-1">
                        ...
                        <div className="flex items-center gap-2 mt-1.5">
                          <button
                            ...
                            className="text-xs font-medium px-3 py-1.5 bg-gray-900 text-white rounded-full hover:bg-gray-700 disabled:opacity-40 transition-colors"
                          >
